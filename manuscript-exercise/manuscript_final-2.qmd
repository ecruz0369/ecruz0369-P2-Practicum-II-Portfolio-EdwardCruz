...
production and broader food security.
...
Using this in RMarkdown:
#Make sure to save these entries in a file names'reference.bib' and include it in your R Markdown document like this:
...
![](images/varroa-mite-bee-01.webp){fig-align="center" width="244"}

### **VARROA MITE**

![](images/Varrpa%201-02.webp){fig-align="center" width="246"}

\*\*\*\*\*\*\*\*\*\*\*\*\*\* Leo provided additional code below and
works perfectly\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*\*
...
![](images/Bee%20Feeding-01.jpg){fig-align="center" width="523"}
